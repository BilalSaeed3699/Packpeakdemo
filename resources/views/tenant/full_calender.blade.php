...
<meta name="csrf-token" content="{{ csrf_token() }}" /> 
  ...
  <body>
   ...
   <a href="{{url('calender_event_delete')}}">check</a> 
    ...
    <div class="modal" tabindex="-1" role="dialog" id="alert-models">
    ...
    <div class="modal-content">
	 ...
	 <!-- <input type="text" name="type" id="type" > -->
      <div>
        ...
        <div>
            <input type="text" name="event_name" id="name" placeholder="Event">
        </div>
...
//document.getElementById("getdate").value =finaltime;
                    var data = startDate.getDate();
                    var monthdata = startDate.getMonth() +  1;
                    var fullyear =  startDate.getFullYear();
                   // var time = startDate.time();
                    var finaldate = fullyear+"/"+monthdata+"/"+data;
                   // var finaldate = data+"/"+monthdata+"/"+fullyear;
                    document.getElementById("getdate").value = finaldate+" "+finaltime;
                    //var newDate = data.toString('dd-MM-yy');
                   // alert(finaldate);
                    // swal({
                    //   //  $('#alert-models').modal('show'); 
                    //     input: 'text',
...
$.ajax({
   ...
   error:function(error){
     ...
     <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.js" integrity="sha256-iT6Q9iMJYuQiMWNd9lDyBUStIq/8PuOW33aOqmvFpqI=" crossorigin="anonymous"></script>
